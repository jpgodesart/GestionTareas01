...
<table class="table table-hover table-condensed">
    ...
    <tr>
        ...
        <td><%=oCuestionarioBEAN.getFecha()%></td>
        <td><%=oCuestionarioBEAN.getEvaluacion()%></td>
        <td><%=oCuestionarioBEAN.getActivo()%></td>
        <td>
            <div class="btn-toolbar">
                <div class="btn-group">                    
                    <a class="btn btn-mini" href="Controller?class=compra&method=list&filter=id_cuestionario&filteroperator=equals&filtervalue=<%=oCuestionarioBEAN.getId()%>">Compras</a>
                </div>
            </div>
        </td>        
        <td>
