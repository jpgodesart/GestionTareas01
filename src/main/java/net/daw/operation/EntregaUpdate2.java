 ...
 * @author rafa
 */
public class EntregaUpdate2 implements Operation {
    ...
    public Object execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        switch (oContexto.getSearchingFor()) {
            ...
            default:
                ...
                String strMensaje = "Se ha modificado la información de la entrega con id=" + Integer.toString(oEntregaBean.getId()) + "<br />";
                strMensaje += "<a href=\"Controller?class=entrega&method=view&id=" + oEntregaBean.getId() + "\">Ver entrega modificada</a><br />";
                return strMensaje;
        }
    }
