 ...
 */
public class TipodocumentoNew2 implements Operation {
    ...
    public Object execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            throw new ServletException("TipodocumentoController: New Error: Phase 2: " + e.getMessage());
        }
        String strMensaje = "Se ha añadido la información del tipodocumento con id=" + Integer.toString(oTipodocumentoBean.getId()) + "<br />";
        strMensaje += "<a href=\"Controller?class=tipodocumento&method=view&id=" + oTipodocumentoBean.getId() + "\">Ver tipodocumento creado en el formulario</a><br />";
        return strMensaje;
    }
}
