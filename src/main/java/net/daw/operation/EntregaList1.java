    ...
    public Object execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (tipoUsuario.equals(net.daw.helper.Enum.TipoUsuario.Profesor)
            ...
            try {
                ...
                ArrayList<EntregaBean> listado = (ArrayList<EntregaBean>) oEntregaDAO.getPage(oContexto.getNrpp(), oContexto.getPage(), oContexto.getAlFilter(), oContexto.getHmOrder());
                String strUrl = "<a href=\"Controller?" + oContexto.getSerializedParamsExceptPage() + "&page=";            
                //ArrayList<String> vecindad = (ArrayList<String>) oEntregaDAO.getNeighborhood(strUrl, oContexto.getPage(), intPages, 2);
                ...
                throw new ServletException("EntregaList1: View Error: " + e.getMessage());
            }
        }else {
