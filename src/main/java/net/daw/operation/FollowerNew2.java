 ...
 * @author al037570
 */
public class FollowerNew2 implements Operation {
        ...
        if (tipoUsuario.equals(net.daw.helper.Enum.TipoUsuario.Profesor)) {
            switch (oContexto.getSearchingFor()) {
                ...
                default:
                    ...
                    String strMensaje = "Se ha añadido la información de follower con id=" + Integer.toString(oFollowerBean.getId()) + "<br />";
                    strMensaje += "<a href=\"Controller?class=follower&method=list&filter=id_usuario2&filteroperator=equals&filtervalue=" + oFollowerBean.getUsuario2().getId() + "\">Ver followers de este usuario</a><br />";
                    strMensaje += "<a href=\"Controller?class=follower&method=view&id=" + oFollowerBean.getId() + "\">Ver follower creada</a><br />";
                    return strMensaje;
