...
public class ActividadofflineUpdate2 implements Operation{
    ...
    @Override
     public Object execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
         ...
         return "Se ha modificado la información del cliente con id=" + Integer.toString(oActividadOfflineBean.getId());
     }
