 ...
 */
public class UsuproUpdate2 implements Operation {
        ...
        if (tipoUsuario.equals(net.daw.helper.Enum.TipoUsuario.Profesor)) {
            ...
            switch (oContexto.getSearchingFor()) {
                ...
                default:
                    ...
                    String strMensaje = "Se ha modificado la información de la usupro con id=" + Integer.toString(oUsuproBean.getId()) + "<br />";
                    strMensaje += "<a href=\"Controller?class=usupro&method=view&id=" + oUsuproBean.getId() + "\">Ver usupro modificada</a><br />";
                    return strMensaje;
            }
        } else {
