...
public class ContestacionDao {
    ...
    public int getPages(int intRegsPerPag, ArrayList<FilterBean> alFilter, HashMap<String, String> hmOrder) throws Exception {
        ...
        try {
            ...
            throw new Exception("ContestacionDao.getPages: Error: " + e.getMessage());
        } finally {
            oMysql.desconexion();
        }
    }
    ...
    public ArrayList<ContestacionBean> getPage(int intRegsPerPag, int intPage, ArrayList<FilterBean> alFilter, HashMap<String, String> hmOrder) throws Exception {
        ...
        try {
            ...
            throw new Exception("ContestacionDao.getPage: Error: " + e.getMessage());
        } finally {
            oMysql.desconexion();
        }
    }
    ...
    public ContestacionBean get(ContestacionBean oContestacionBean) throws Exception {
        try {
            ...
            oUsuarioDao = oUsuarioDao.get(oUsuarioBean);
            oPreguntaDao = oPreguntaDao.get(oPreguntaBean);
            oOpcionDao = oOpcionDao.get(oOpcionBean);
            ...
            throw new Exception("ContestacionDao.get: Error: " + e.getMessage());
        } finally {
            oMysql.desconexion();
        }
